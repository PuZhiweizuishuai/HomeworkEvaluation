...
public interface NotificationService extends IService<NotificationEntity> {
     ...
     * @param courseId 课程ID
     * */
    void sendBulletin(List<StudentsCurriculumEntity> userList, String notifier, Long courseId);
     ...
     * */
    void sendNewExam(List<StudentsCurriculumEntity> userListInCurriculum, String notifier, CurriculumEntity curriculumEntity, HomeworkEntity homeworkEntity);
     ...
     * @param notifier 消息发送人
     * */
    void sendJoinCourseToUser(List<StudentsCurriculumEntity> students, String notifier, CurriculumEntity curriculumEntity);
